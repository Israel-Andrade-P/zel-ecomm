    ...
    return (
        <div>
                    ...
                    <DialogPanel transition className="relative mr-16 flex w-full max-w-xs flex-1 transform transition duration-300 ease-in-out data-closed:translate-x-full">
                        <TransitionChild>
                            <div className="absolute left-full top-0 flex w-16 justify-center pt-5 duration-300 ease-in-out data-closed:opacity-0">
                                <button type="button" onClick={() => setSidebarOpen(false)} className="-mb-2.5 p-2.5">
            ...
            <div className="xl:pl-72">
                <button type="button" onClick={() => setSidebarOpen(true)} className="-m-0 text-gray-700 xl:hidden">
