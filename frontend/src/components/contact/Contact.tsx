...
const Contact = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-12 bg-cover bg-center" style={{ backgroundImage: "url('')" }}>
            ...
            <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-lg">
                ...
                <p className="text-gray-600 text-center mb-4">
                    Any feedback is appreciated! Fill out the form bellow, or reach out to us directly through our socials.
                </p>
                ...
                <div className="mt-8 text-center">
                    ...
                    <div className="flex flex-col items-center space-y-2 mt-4">
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-600">+55 (85) 999444600</span>
                        </div>
                        <div className="flex items-center">
                            <FaEnvelope className="text-blue-500 mr-2" />
                            <span className="text-gray-600">zel4569@gmail.com</span>
                        </div>
                        <div className="flex items-center">
                            <FaMapMarkedAlt className="text-blue-500 mr-2" />
                            <span className="text-gray-600">Granja Portugal 69th Avenue, New Zealand</span>
                        </div>
                    </div>
                </div>
            </div>
